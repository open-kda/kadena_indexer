...
def process_collections():
    ...
    try:
        ...
        for event in create_collection_events:
            ...
            print(f"Processed CREATE-COLLECTION for {collection_id}")
        ...
        for event in add_to_collection_events:
            ...
            if update_result.modified_count > 0 or update_result.upserted_id:
                ...
                print(f"Added new NFT {nft_id} to collection {collection_id} and incremented size")
            else:
                print(f"NFT {nft_id} already in collection {collection_id}. Size not incremented.")
